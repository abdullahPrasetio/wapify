...
| 6 | SaaS (Opsional) | Cloud hosted di wapbolt.io | ⬜ Belum Mulai |
...
**Target:** Tim Waluyo (15+ orang) bisa pakai Wapbolt sebagai pengganti Postman minggu ini.
**Estimasi:** 4-5 hari
...
- [x] Admin CLI: `wapbolt-admin create-user --email --name --password --super`
- [x] Admin CLI: `wapbolt-admin list-users`
- [ ] Admin CLI: `wapbolt-admin reset-password --email --password`
...
- [ ] CLI: `wapbolt run --collection --env --reporter json|junit`
- [x] UI: test script editor + laporan hasil

**Milestone ✅:** `wapbolt run` bisa dipakai di pipeline CI/CD.

---

## Fase 5 — On-Premise & License
**Target:** Wapbolt bisa dijual ke client luar dengan model on-premise license.
...
**Target:** Wapbolt tersedia sebagai cloud SaaS.
